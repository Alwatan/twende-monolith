...
- [ ] **Step 12: Verify** — run `./mvnw -pl pricing-service clean verify`, confirm all tests pass with minimum 80% line coverage (JaCoCo), check report at `target/site/jacoco/index.html`

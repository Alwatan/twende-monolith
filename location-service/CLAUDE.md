...
- [ ] **Step 22: Verify** — run `./mvnw -pl location-service clean verify`, confirm all tests pass with minimum 80% line coverage (JaCoCo), check report at `target/site/jacoco/index.html`

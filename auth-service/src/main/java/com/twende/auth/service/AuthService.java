...
import com.twende.auth.dto.RegisterRequestDto;
import com.twende.auth.dto.TokenResponseDto;
import com.twende.auth.dto.UserInfoDto;
import com.twende.auth.entity.AuthUser;
import com.twende.auth.entity.OtpCode;
import com.twende.auth.repository.AuthUserRepository;
import com.twende.common.enums.UserRole;
import com.twende.common.event.user.UserRegisteredEvent;
